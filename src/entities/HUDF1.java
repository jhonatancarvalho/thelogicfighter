...
public class HUDF1 {
	...
	public void LoadHUDF1Texture() {

		dialogMovimentos = new Dialog("F1", Assets.skin);
		dialogMovimentos.setName("dialogF1");
		...
		dialogMovimentos.setBounds(GameScreen.w, GameScreen.h-276, 186, 115);
